...
import com.pogiba.core.util.AndroidComponentUtil;
import com.pogiba.core.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        CoreApplication.get(this).getComponent().inject(this);
    }
